        ...
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 mt-40 w-full text-slate-500">
            {/* <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-200 pb-6">
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20">
                    <div>
                        <h2 className="font-semibold mb-5 text-gray-800">SiteForge</h2>
                        <ul className="space-y-2">
                            {navLinks.map((link, index) => (
                                <li key={index}>
                                    <Link to={link.path} className="hover:text-indigo-600">{link.name}</Link>
                                </li>
                            ))}
                        </ul>
                    </div>
                    <div>
                        ...
                        <div className="space-y-2">
                            <p>+1-212-456-7890</p>
                            <p>siteforge.ai@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div> */}
            <p className="pt-4 text-center pb-5">
                Copyright 2024 © SiteForge. All Right Reserved.
            </p>
        </footer>
    );
};